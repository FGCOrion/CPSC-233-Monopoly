...
class Board {
  ...
  public Board() {
    ...
    Space space3 = new Space("Yellow 2", 200, 75, 100, 0, 3);			//37.5%
    Space space4 = new Space("Yellow 3", 250, 100, 125, 0, 4);			//40.0%
    Space space5 = new Space("Chance", 0, 0, 0, 11, 5);
    Space space6 = new Space("Jail", 0, 0, 0, -1, 6);

		Space space7 = new Space("Blue 1", 350, 150, 175, 0, 7);		//42.9%
		Space space8 = new Space("Blue 2", 400, 175, 200, 0, 8);		//43.8%
		Space space9 = new Space("Railroad 2", 200, 100, 100, 0, 9);
		Space space10 = new Space("Blue 3", 450, 200, 225, 0, 10);		//44.4%
		...
		Space space19 = new Space("Orange 1", 750, 350, 375, 0, 19);	//46.7%
		Space space20 = new Space("Orange 2", 800, 375, 400, 0, 20);	//46.9%
		Space space21 = new Space("Community Fund", 0, 0, 0, 14, 21);
		Space space22 = new Space("Green 1", 900, 425, 450, 0, 22);		//47.2%
		Space space23 = new Space("Green 2", 1000, 500, 500, 0, 23);	//50.0%  This one is intentionally skewed
